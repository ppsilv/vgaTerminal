...
private:
  static Serial0 * instance;
   ...
   const int BAUD      = 9600;       // Any baudrate from 300 to 115200
   const int TEST_UART = 1;          // Serial1 will be used for the loopback testing with different RX FIFO FULL values
